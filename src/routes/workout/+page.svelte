...
<script lang="ts">
	...
	import { DataVisualizationSection, Day1Plot } from '$lib/components/data-visualization';
...
<div class="workout-page">
	...
	<DataVisualizationSection
		data={sets}
		day={data.workoutData.day === 5 && selectedDay ? selectedDay : data.workoutData.day}
	/>
