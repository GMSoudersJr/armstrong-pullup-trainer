export type ArmstrongDayNumber = 1 | 2 | 3 | 4 | 5;

export type ArmstongDayName =
	| 'Five Maximum Effort Sets'
	| 'Pyramid'
	| 'Three Sets Three Grips'
	| 'Maximum Training Sets'
	| 'Repeat Your Hardest Day';

export type ArmstongDayAbbreviation =
	| '5MES'
	| 'PYRA'
	| '3S3G'
	| 'MXTS'
